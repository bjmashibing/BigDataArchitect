...
-- 4. 创建function
create function currency_type_convert as 'com.msb.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://node1:8020/msb/transformer/transformer-0.0.1.jar';
create function payment_type_convert as 'com.msb.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://node1:8020/msb/transformer/transformer-0.0.1.jar';
create function order_info as 'com.msb.transformer.hive.OrderInfoUDF' using jar 'hdfs://node1:8020/msb/transformer/transformer-0.0.1.jar';
create function order_total_amount as 'com.msb.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://node1:8020/msb/transformer/transformer-0.0.1.jar';
